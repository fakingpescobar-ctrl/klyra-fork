...
func NewSettingsModal(
	...
	contextCockpitTokens, contextCockpitMaxFiles, contextCockpitMaxCards int,
	contextCockpitDiff bool,
	contextRetrieval bool,
	contextRetrievalTokens, contextRetrievalChunks int,
	...
	fields := []settingsField{
		...
		{Section: secContext, Name: "context_cockpit_cards", DisplayName: "Max Cards", Value: fmt.Sprintf("%d", contextCockpitMaxCards)},
		...
		{Section: secContext, Name: "context_retrieval", DisplayName: "Retrieval Cart", Value: onOff(contextRetrieval), Choices: []string{"on", "off"}},
		{Section: secContext, Name: "context_retrieval_tokens", DisplayName: "Retrieval Tokens", Value: fmt.Sprintf("%d", contextRetrievalTokens)},
		{Section: secContext, Name: "context_retrieval_chunks", DisplayName: "Retrieval Chunks", Value: fmt.Sprintf("%d", contextRetrievalChunks)},
		{Section: secContext, Name: "context_embeddings", DisplayName: "Embeddings", Value: onOff(contextEmbeddings), Choices: []string{"on", "off"}},
		{Section: secContext, Name: "context_reranker", DisplayName: "Reranker", Value: onOff(contextReranker), Choices: []string{"on", "off"}},
